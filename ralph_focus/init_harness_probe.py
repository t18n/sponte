...
def probe_init_harness_selection(
    ...
    *,
    ...
    if hid == "custom":
        return _probe_custom_harness(primary, custom)
    return _probe_builtin_harness(primary, hid, plan_model.strip(), execute_model.strip())


def _probe_custom_harness(primary: Path, custom: CustomHarnessConfig | None) -> str | None:
